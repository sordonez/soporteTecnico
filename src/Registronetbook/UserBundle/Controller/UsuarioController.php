...
use Registronetbook\UserBundle\Form\Type\UsuarioType;
...
class UsuarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UserBundle:AppUser')->findAll();

        return $this->render('UserBundle:AppUser:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('UserBundle:AppUser:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UserBundle:AppUser')->find($id);
        ...
        return $this->render('UserBundle:AppUser:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('UserBundle:AppUser:edit.html.twig', array(
            'entity'      => $entity,
