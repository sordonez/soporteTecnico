...
use Registronetbook\ControlBundle\Entity\Estado;
use Registronetbook\ControlBundle\Form\EstadoType;
...
class EstadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ControlBundle:Estado')->findAll();

        return $this->render('ControlBundle:Estado:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ControlBundle:Estado:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Estado $entity)
    {
        $form = $this->createForm(new EstadoType(), $entity, array(
            'action' => $this->generateUrl('admin_estado_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ControlBundle:Estado')->find($id);
        ...
        return $this->render('ControlBundle:Estado:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ControlBundle:Estado:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new EstadoType(), $entity, array(
            'action' => $this->generateUrl('admin_estado_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_estado_delete', array('id' => $id)))
            ->setMethod('DELETE')
