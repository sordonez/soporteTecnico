...
use Registronetbook\ControlBundle\Entity\Problema;
use Registronetbook\ControlBundle\Form\ProblemaType;
...
class ProblemaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ControlBundle:Problema')->findAll();

        return $this->render('ControlBundle:Problema:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ControlBundle:Problema:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Problema $entity)
    {
        $form = $this->createForm(new ProblemaType(), $entity, array(
            'action' => $this->generateUrl('admin_problema_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ControlBundle:Problema')->find($id);
        ...
        return $this->render('ControlBundle:Problema:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ControlBundle:Problema:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new ProblemaType(), $entity, array(
            'action' => $this->generateUrl('admin_problema_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_problema'));
    }
