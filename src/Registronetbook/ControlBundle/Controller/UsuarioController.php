...
class UsuarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('ControlBundle:Usuario:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ControlBundle:Usuario:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ControlBundle:Usuario')->find($id);
        ...
        return $this->render('ControlBundle:Usuario:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ControlBundle:Usuario:edit.html.twig', array(
            'entity'      => $entity,
